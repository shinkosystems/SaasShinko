...
            // SELETOR DE DATAS ORIGINAL (CORRIGIDO)
            Padding(
              padding: const EdgeInsets.only(top: 8.0),
              child: TextButton(
                onPressed: () {
                  print('>>> Botão de período Clicado!'); // Linha de teste
...
              ),
            ),
            // FIM DO SELETOR DE DATAS

            const SizedBox(height: 16),

            // Botão de teste para o Date Picker (removido do body duplicado)
            Center(
              child: ElevatedButton(
                onPressed: () {
                  print('>>> Botão de teste Clicado!'); // Linha de teste
                  _selectDateRange(context);
                },
                child: const Text('Testar Date Picker'),
              ),
            ),
